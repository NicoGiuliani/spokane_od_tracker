    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            ...
            <ul class="form-text text-muted small">
                <li>Your password cannot be too similar to your other information</li>
        ...
        self.fields["password2"].help_text = (
            '<span class="form-text text-muted"><small>Enter your password again to confirm</small></span>'
        )
